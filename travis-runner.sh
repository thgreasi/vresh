...
then
  ...
  deploy_ghpages () {
    # Deploying to GitHub Pages! (http://thgreasi.github.io/vresh)
    echo Deploying to GitHub Pages
    sed -i.tmp "s/\/\/ app.baseUrl = '\/vresh/app.baseUrl = '\/vresh/" app/scripts/app.js
  ...
  deploy_firebase () {
    # Deploying to Firebase! (https://vresh.firebaseapp.com)
    ...
    gulp
    # Starting Deploy Process to Firebaseapp.com Server -- vresh.firebaseapp.com
